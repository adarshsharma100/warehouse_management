  ...
  return (
    <section className="bg-white">
      <div className="grid min-h-screen col-12">
        <main
          aria-label="Main"
          className="flex p-5 align-items-center justify-content-center col-12 lg:col-7 xl:col-6"
        >
          <div className="max-w-30rem lg:max-w-3xl">
        ...
        <aside className="relative block h-auto order-last lg:col-5 h-full xl:col-6">
          <img
            alt="Pattern"
